...
class Images(APIView):
    ...
    def post(self, requset, format=None):
        user = requset.user
        serializer = serializers.InputImageSerializer(data=requset.data)
...
class LikeImage(APIView):
    ...
    def post(self, request, image_id, format=None):
        ...
        try:
            preexisting_like = models.Like.objects.get(creator=user, image=found_image)
            return Response(status=status.HTTP_304_NOT_MODIFIED)
        except models.Like.DoesNotExist:
            new_like = models.Like.objects.create(
                creator=request.user, image=found_image
            )
            new_like.save()
...
class ImageDetail(APIView):
    ...
    def get(self, request, image_id, format=None):
        ...
        except modles.Image.DoesNotExist:
            return Response(status=status.HTTP_404_NOT_FOUND)
